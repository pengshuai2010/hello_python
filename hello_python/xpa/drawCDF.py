...
if __name__ == '__main__':
    policyname = '2faults/conference3'
    ...
    if policyname == 'itrust3':
        ...
        # set axis ticks
        x_major_ticks = np.arange(0, 12000, 1000)
        x_minor_ticks = np.arange(0, 12000, 500)
        ...
        # plt.annotate('{} milliseconds'.format(715), xy=(851, 0.04), textcoords='data')
        # set axis ticks
        x_major_ticks = np.arange(0, 500, 100)
        x_minor_ticks = np.arange(0, 500, 50)
        ax.set_xticks(x_major_ticks)
        ax.set_xticks(x_minor_ticks, minor=True)
        ...
        # set axis ticks
        x_major_ticks = np.arange(0, 500000, 100000)
        x_minor_ticks = np.arange(0, 500000, 50000)
        ax.set_xticks(x_major_ticks)
        ax.set_xticks(x_minor_ticks, minor=True)
